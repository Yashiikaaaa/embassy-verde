...
export default function FAQs() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Embassy Verde is located in Devanahalli, North Bengaluru, just 9–10 km from Kempegowda International Airport, offering quick airport access and strong connectivity via NH-44.",
    },
    {
      question: "When does the pre booking start for the project?",
      answer:
        "Pre-bookings for the project are scheduled to begin from the month of January, 2026. Interested buyers can register their interest in advance to secure priority access",
    },
    {
