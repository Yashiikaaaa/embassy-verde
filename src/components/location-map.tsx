...
export default function LocationMap() {
  ...
  { name: "Akash Hospital", distance: "4 KM" },
  { name: "Ramaiah Leena Hospital", distance: "7 KM" },
  
    ],
    schools: [
    { name: "Oxford English School ", distance: "7 KM" },
  { name: "Stonehill International School", distance: "18 KM" },
  { name: "Akash International School", distance: "4 KM" },
  { name: "Canadian International School,", distance: "20 KM" },
 

    ],
    connectivity: [
      
{ name: "Kempegowda International Airport", distance: "9 km" },
{ name: "Upcoming metro extension ", distance: "5 km" },
{ name: "NH-44", distance: "3 km" },
{ name: "Bellary Road", distance: "2 km" },

    ],

    entertainment: [
    { name: "RMZ Galleria Mall", distance: "20 KM" },
  { name: "Esteem Mall", distance: "24 KM" },
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-8 lg:gap-12 items-start w-full">
          ...
          <div className="relative rounded-lg overflow-hidden shadow-lg w-full">
            <div className="relative h-[280px] sm:h-[350px] md:h-[500px] bg-neutral-200">
              ...
              <iframe
                title="Location Map"
               src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3692.095503361812!2d77.61073393488769!3d13.207303500000004!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae1f2b815196af%3A0x35787311c589cd45!2sEmbassy%20Verde!5e1!3m2!1sen!2sin!4v1764668500288!5m2!1sen!2sin"                 width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
                loading="lazy"
              ...
              <button className="absolute top-4 md:top-4 right-4 md:right-4 bg-primary text-white px-5 md:px-8 py-2 md:py-3 rounded-[4px] font-semibold font-['Urbanist'] text-sm md:text-[14px] transition-colors duration-300 shadow-lg cursor-pointer"
                onClick={() => {
                  window.open("https://maps.app.goo.gl/uiWy1MSDNZmKfi7o7", "_blank")
                }}
              >
                Explore
              </button>
