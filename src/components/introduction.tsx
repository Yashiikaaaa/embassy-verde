        ...
        <div className="grid md:grid-cols-2  lg:gap-12 items-center">
          ...
          <div>
            <h2 className="text-3xl md:text-4xl lg:text-[44px] font-extrabold mb-6 text-[#221628] font-['Urbanist']">
              Embassy Verde - Homes in Nature

            </h2>
            
            <p className="text-[#575556] mb-4 leading-relaxed text-sm md:text-md font-['Urbanist']">
             Embassy Verde by Embassy Group brings modern, nature-focused living to the heart of Embassy Springs in Devanahalli, one of North Bengaluru’s most promising residential destinations. The project features thoughtfully designed towers set amid generous green and landscaped spaces, ensuring ample natural light, ventilation, and soothing open views.
            </p>
            <p className="text-[#575556] mb-8 leading-relaxed text-sm md:text-md font-['Urbanist']">
            Situated within Bengaluru’s largest integrated township, Embassy Verde offers a balanced lifestyle with seamless access to essential conveniences, township amenities, and well-planned infrastructure. It combines urban comfort with a calm, community-friendly environment, making it an ideal choice for future-ready living.
            </p>
            {/* Buttons */}
            ...
            <div className="grid grid-cols-3 gap-6 font-['Urbanist']">
              ...
              <div className="text-center">
                <p className="text-lg md:text-[42px] font-bold text-gray-900 mb-2">60+</p>
                <p className="text-md text-[#575556]">Projects Delivered</p>
              </div>
              <div className="text-center">
                <p className="text-lg md:text-[42px] font-bold text-gray-900 mb-2">50M+</p>
