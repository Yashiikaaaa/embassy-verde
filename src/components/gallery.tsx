...
export default function Gallery() {
  ...
  const images = [
    { src: "/assets/gallery/verde2.png", desktopCols: 1, mobileRows: 1 },
    { src: "/assets/gallery/image4.png", desktopCols: 3, mobileRows: 1 },
    { src: "/assets/gallery/image.png", desktopCols: 2, mobileRows: 2 },
    { src: "/assets/gallery/verde1.png", desktopCols: 3, mobileRows: 2 },
